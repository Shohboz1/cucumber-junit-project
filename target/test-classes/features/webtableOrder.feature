Feature: Web table user order feature
  ...
  Scenario: User should be able to place  order and order seen in web table
    ...
    Then user should see "Sherlock Holmes" in first row of the web tables"
  ...
  Scenario Template: User should be able to place  order and order seen in web table
    ...
    And user enters process order button
    Then user should see "<expectedName>" in first row of the web tables"
    ...
    Examples: Famous male scientist
      ...
      | Screenable  | 2        | Alexandr Flaming | 221B Baker Street | London | England | 50505   | visa     | 1111222233334444 | 12/23      | Alexandr Flaming |
