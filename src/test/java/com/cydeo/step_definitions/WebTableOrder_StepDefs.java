...
public class WebTableOrder_StepDefs {
    ...
    public void user_is_already_logged_in_and_on_order_page() {
        ...
        webTableLoginPage.login(ConfigretionReader.getProperty("username"), ConfigretionReader.getProperty("password"));
    ...
    public void user_enters_quantity(Integer int1) {
        ...
        // first we need to clean that input then we will send key later
...
//        }
        ...
        BrowserUtil.clickRadioButton(webTableOrderPage.cardType, string);
    ...
    @Then("user should see {string} in first row of the web tables\"")
    public void user_should_see_in_first_row_of_the_web_tables(String expectedCustomerName) {
